...
import { INITIAL_TEACHERS, INITIAL_STUDENTS, INITIAL_ATTENDANCE } from "./constants";
...
export default function App() {
  ...
  function login(u) { setUser(u); setPage("dash"); }
  function logout() { setUser(null); setPage("dash"); }

  if (!user) {
    return <Login onLogin={login} teachers={teachers} students={students} />;
  }

  const props = { att, setAtt, teachers, setTeachers, students, setStudents, toast: showToast, user };
